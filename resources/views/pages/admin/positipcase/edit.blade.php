...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Kasus Positip  {{ $item->id }} </h1> 
    </div>
  ...
  <div class="card shadow">
    <div class="card-body">
        <form action="{{ route('positips.update', $item->id)}}" method="POST" enctype="multipart/form-data">
         @method('PUT')
         @csrf
            ...
            <div class="form-group">
                <label for="jumlah">Jumlah Kasus Positip</label>
