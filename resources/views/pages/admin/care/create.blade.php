...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Form Tambah Kasus Perawatan</h1> 
    </div>
  ...
  <div class="card shadow">
    <div class="card-body">
        <form action="{{ route('cares.store')}}" method="POST" enctype="multipart/form-data">
         @csrf         
            ...
            <div class="form-group">
                <label for="jumlah">Jumlah Kasus Perawatan</label>
